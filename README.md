...
└── assets/
    ...
    └── js/
        ...
        ├── auth.js          登录态管理
        ├── menu.js          角色动态菜单
        ├── governance-dict.js  治理域枚举文案与样式集中定义（标准状态/资产类型/敏感等级色阶/检查类型/试用提示三档；L3收口：风险类别/风险状态/风险等级四档色阶/合规框架/检查结果四色/案例状态；商用化 case-20260823：套餐编码/套餐上下架/SLA 三档承诺文案（全站唯一集中处）/账单状态/事故恢复状态）
